...
/// <summary>
/// An implementation of <see cref="MemoryOwner{T}"/> from CommunityToolkit which supports <see cref="IEnumerable{T}"/>.
/// </summary>
/// <typeparam name="T">The type of items to store in the current instance.</typeparam>
[DebuggerTypeProxy(typeof(MemoryDebugView<>))]
[DebuggerDisplay("{ToString(),raw}")]
public sealed class MemoryOwner<T> : IMemoryOwner<T>, IEnumerable<T>
{
    /// <summary>
...
#pragma warning restore CA1816
    ...
    public IEnumerator<T> GetEnumerator() => DangerousGetArray().GetEnumerator();
